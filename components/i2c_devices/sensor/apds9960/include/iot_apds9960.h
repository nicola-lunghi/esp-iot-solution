...
#ifndef _IOT_APDS9960_H_
#define _IOT_APDS9960_H_
...
/**
 * @brief Write value to a register of APDS9960
 *
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_write_byte(apds9960_handle_t sensor, uint8_t reg_addr,
        uint8_t data);

/**
 * @brief Write value to multiple register of APDS9960
 *
 * @param sensor object handle of apds9960
 * @param addr start address of register
 * @param buf Pointer of register values buffer
...
/**
 * @brief Read value from a register of APDS9960
 *
 * @param sensor object handle of apds9960
 * @param reg_addr register address
 * @param data register value
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_read_byte(apds9960_handle_t sensor, uint8_t reg_addr, uint8_t *data);

/**
 * @brief Read value from multiple register of APDS9960
 *
 * @param sensor object handle of apds9960
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_gesture_init();
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_adc_integration_time(apds9960_handle_t sensor,
        uint16_t iTimeMS);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_ambient_light_gain(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_led_drive_boost(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_proximity_gain(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_proximity_pulse(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_proximity_interrupt_threshold(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_dimensions(apds9960_handle_t sensor,
        uint8_t dims);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_fifo_threshold(apds9960_handle_t sensor,
        uint8_t thresh);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_gain(apds9960_handle_t sensor, apds9960_ggain_t gGain);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_proximity_threshold(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_offset(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_gesture_pulse(apds9960_handle_t sensor,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_get_color_data(apds9960_handle_t sensor, uint16_t *r,
 ...
 */
uint16_t iot_apds9960_calculate_color_temperature(apds9960_handle_t sensor,
 ...
 */
uint16_t iot_apds9960_calculate_lux(apds9960_handle_t sensor, uint16_t r,
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_int_limits(apds9960_handle_t sensor, uint16_t l,
        uint16_t h);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_light_intlow_threshold(apds9960_handle_t sensor,
        uint16_t threshold);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t iot_apds9960_set_light_inthigh_threshold(apds9960_handle_t sensor,
        uint16_t threshold);
 ...
 *     - Others Success
 */
apds9960_handle_t iot_apds9960_create(i2c_bus_handle_t bus,
        uint16_t dev_addr);
...
{
private:
    apds9960_handle_t m_sensor_handle;
    CI2CBus *bus;

    /**
     * prevent copy constructing
     */
    CApds9960(const CApds9960&);
    CApds9960& operator =(const CApds9960&);
public:
    /**
     * @brief   constructor of APDS9960
     *
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_adc_integration_time(uint16_t iTimeMS);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_ambient_light_gain(apds9960_again_t gain);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_led_drive_boost(apds9960_leddrive_t drive,
     ...
     *     - iTimeMS the integration time for the ADC of the APDS9960
     */
    float get_adc_integration_time(void);
     ...
     *     - the color/ALS gain on the APDS9960
     */
    apds9960_again_t get_ambient_light_gain(void);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_proximity(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_proximity_interrupt(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_proximity_gain(apds9960_pgain_t gain);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_proximity_pulse(apds9960_ppulse_len_t pLen, uint8_t pulses);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_proximity_interrupt_threshold(uint8_t low, uint8_t high,
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_gesture(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_gesture_interrupt(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_pulse(apds9960_gpulselen_t gLen, uint8_t pulses);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_dimensions(uint8_t dims);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_fifo_threshold(uint8_t thresh);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_waittime(apds9960_gwtime_t time);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_gain(apds9960_ggain_t gain);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_proximity_threshold(uint8_t entthresh, uint8_t exitthresh);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_gesture_offset(uint8_t offset_up, uint8_t offset_down,
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_color(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t get_color_data(uint16_t *r, uint16_t *g, uint16_t *b,
            uint16_t *c);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_color_interrupt(bool en = true);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_int_limits(uint16_t l, uint16_t h);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t enable_device(bool en = true);
};
#endif
